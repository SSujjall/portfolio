...
const Home: React.FC = () => {
  return (
    <div className="border-2 border-black h-full flex items-center justify-center px-6">
      <div className="main-container border border-green-700 h-4/5 w-full max-w-[1280px] bg-zinc-400 dark:bg-zinc-500 flex flex-row overflow-hidden" style={{ borderRadius: "35px" }}>
        {/* Left Section */}
        <div className="w-[30%] overflow-y-auto custom-scrollbar">
          <div className="flex flex-col items-center py-16">
            ...
            <img
              ...
              className="rounded-full min-w-44 border-white overflow-hidden"
        ...
        {/* Right Section */}
        <div className="bg-zinc-200 rounded-l-3xl w-[70%] text-black dark:bg-zinc-700 dark:text-white">
